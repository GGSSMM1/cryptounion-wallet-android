...
import io.cryptounion.bankwallet.modules.settings.main.MainSettingsAdapter
import io.cryptounion.bankwallet.modules.settings.main.SettingsMenuItem
...
class AboutFragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val contactItem = SettingsMenuItem(R.string.SettingsContact_Title, R.drawable.ic_email, listPosition = ListPosition.Single) {
            ...
            val data = Uri.parse("mailto:?subject=" + "subject text" + "&body=" + "Enter Text Here " + "&to=" + "contact@cryptoUnion.com")
