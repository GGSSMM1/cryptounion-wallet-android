...
class AppConfigProvider : IAppConfigProvider, ILanguageConfigProvider, IBuildConfigProvider {
    ...
    override val companyWebPageLink: String = "http://cryptounion.world"
    override val appWebPageLink: String = "http://cryptounion.world"
    override val appGithubLink: String = "https://github.com/GGSSMM1/cryptounion-wallet-android"
    ...
    override val reportEmail = "contact@cryptounion.com"
